...
<!-- Right navbar links -->
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item has-treeview">
                ...
                <li class="nav-item has-treeview menu-open">
                  <a href="/admin/couriers" class="nav-link active">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Kelompok 12 Prognet <a href="https://www.facebook.com/dekwik.bagus/" target="_blank">IKDYP</a>.</strong>
  </footer>
...
<!-- daterangepicker -->
<script src="{{asset('plugins/moment/moment.min.js')}}" src=""></script>

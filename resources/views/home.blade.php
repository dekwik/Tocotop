							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">Toko Computer Dan Laptop</div>
										<div class="home_slider_subtitle">Sedia Laptop dan Sparepart Computer</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">Computer</div>
										<div class="home_slider_subtitle">Beli Sparepart Computer di Tocotop.com</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">Laptop</div>
										<div class="home_slider_subtitle">Beli Laptop di Tocotop.com</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="avds_xl_container clearfix">
						...
						<div class="avds_xl_content">
							<div class="avds_title">Tocotop.com</div>
							<div class="avds_text">Toko computer dan laptop yang menyediakan sparepart computer maupun pembelian laptop</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
						<div class="footer_logo"><a href="#">Tocotop.com</a></div>
						<div class="copyright ml-auto mr-auto"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy; All rights reserved | by <a href="#" target="_blank">ILU</a></div>
						<div class="footer_social ml-lg-auto">
							<ul>
								<li><a href="https://www.instagram.com/jagung_matah/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
								<li><a href="https://www.facebook.com/dekwik.bagus/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
